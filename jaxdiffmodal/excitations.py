# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/excitations.ipynb.

# %% auto 0
__all__ = ["create_1d_raised_cosine", "create_raised_cosine", "create_pluck_modal"]

# %% ../nbs/api/excitations.ipynb 2
import numpy as np


# %% ../nbs/api/excitations.ipynb 4
