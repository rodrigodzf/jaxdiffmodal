# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/losses.ipynb.
...
# %% ../nbs/api/losses.ipynb 3
import jax.numpy as jnp
import jax


# %% ../nbs/api/losses.ipynb 5
